#include <iostream>
#include <cstring>
using namespace std;//std네임스페이스 사용합니다

class Employee//Employee 클래스 사용
{
private://외부에서 데이터에 접근하지 못하도록 은닉(Encap)
	char name[100];
public://외부에서 사용할 수 있는 함수의 정의 = 인터페이스
	...
	void ShowYourName() const//const키워드는 중요함 (..?)
	{
		cout << "name: " << name << endl;
	}
	virtual int GetPay() const = 0; // 가상함수, 상속받아 사용할 친구들이라 virtual 키워드 붙임
