...
volatile unsigned int* GPGCON = (unsigned int*)0x56000060; // R/W Configures the pins of port G 0x0
volatile unsigned int* GPGDAT = (unsigned int*)0x56000064; // R/W The data register for port G 0x0
